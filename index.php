		...
		<section class="browser">
			...
			<nav class="browser__nav">
				<button 
					...
					onclick="browseDirectory(DATAS_DIR_PATH), switchToDir('datas')">
					<!-- Title added by JS. -->
				...
				<button
					...
					onclick="browseDirectory(RECYCLE_DIR_PATH), switchToDir('recycle')">
					<!-- Label added by JS. -->
				...
				<button 
					id="empty-recycle-bt" 
					class="browser__nav__bt recycle-feature"
					onclick="removeElm(RECYCLE_DIR_PATH)">
					<!-- Label added by JS. -->
				</button>
			</nav>
