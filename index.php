				...
				<section class="bwr">
					...
					<nav class="bwr__nav">
						...
						<button
							...
							class="bwr__nav__bt"
							onclick="switchTheme()">
							<svg class="bwr__nav__bt__svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10v-20zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12z"/></svg>
						</button>
					</nav>
