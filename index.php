...
<body class="--in-data">
	<main>
		...
		<nav class="main-nav">
			<button class="main-nav__button data-feature" onclick="browseDirectory('./datas')">
			...
			<button class="main-nav__button recycle-feature" onclick="browseDirectory('./recycle')">
		...
		<section class="browser">
			...
			<button onclick="createDirectory()" class="recycle-feature">Ajouter un dossier</button>
