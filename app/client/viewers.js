...
class Controller {
	...
	static searchItem = chunckToSearch => {
		if(chunckToSearch !== null && chunckToSearch.trim() !== '') {
			Model.ajaxPost(
				{
...
ui.lNav.searchBt.setAttribute('title', 'Rechercher des éléments');
...
ui.lNav.searchBt.onclick = () => Controller.searchItem(prompt('Intitulé (partiel ou entier) des éléments à rechercher :'));
...
ui.footer.cirrusVersion.textContent = 'version 1.2.0';
